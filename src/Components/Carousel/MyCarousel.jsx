    ...
    <div className={s.container}>
      ...
      </Carousel>
      {
        ...
        <div onClick={() => { props.dispatch(setVisibleModelAction(true)); props.setPostId(1) }} className={s.btnAdd}>
          <div className={s.next}>
            <svg class="icon icon-tabler icon-tabler-plus" border-radius="50px" color="#cccccc" fill="none" height="30" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" width="30" xmlns="http://www.w3.org/2000/svg">
